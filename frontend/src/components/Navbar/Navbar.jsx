import {
  AppBar, Container, Hidden,
  IconButton, List, ListItem,
  ListItemText, makeStyles, Toolbar, Switch, Fab, FormControlLabel, Paper,
...
const Navbar = ({ darkMode, switchChange }) => {
              ...
              <Container maxWidth="xl" className={classes.navbarDisplayFlex}>
                ...
                <Hidden smDown>
                  <List component="nav" aria-labelledby="main navigation" className={classes.navListDisplayFlex}>
                    <FormControlLabel
                      value="bottom"
                      control={<Switch checked={darkMode} onChange={switchChange} color="secondary" />}
                      label={darkMode === true
